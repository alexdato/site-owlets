...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sections.text'
        db.delete_column(u'theme_sections', 'text')

        # Adding field 'Sections.heading'
        db.add_column(u'theme_sections', 'heading',
    ...
    def backwards(self, orm):
        # Adding field 'Sections.text'
        db.add_column(u'theme_sections', 'text',
                      self.gf('mezzanine.core.fields.RichTextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'Sections.heading'
        db.delete_column(u'theme_sections', 'heading')
