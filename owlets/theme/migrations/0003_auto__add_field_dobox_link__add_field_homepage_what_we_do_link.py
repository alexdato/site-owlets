...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DoBox.link'
        db.add_column(u'theme_dobox', 'link',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=255),
                      keep_default=False)

        # Adding field 'HomePage.what_we_do_link'
        db.add_column(u'theme_homepage', 'what_we_do_link',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DoBox.link'
        db.delete_column(u'theme_dobox', 'link')

        # Deleting field 'HomePage.what_we_do_link'
        db.delete_column(u'theme_homepage', 'what_we_do_link')
