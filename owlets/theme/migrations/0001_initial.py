...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'theme_homepage', (
            ...
            ('introtext_heading', self.gf('django.db.models.fields.CharField')(default='start a love for learning', max_length=200)),
            ('arrangevisit_link', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('seesetting_link', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ...
            ('wedo_heading', self.gf('django.db.models.fields.CharField')(default='some of the things we get upto', max_length=200)),
            ('whatsaying_heading', self.gf('django.db.models.fields.CharField')(default='what parents are saying', max_length='200')),
            ('ourfees_heading', self.gf('django.db.models.fields.CharField')(default='our fees', max_length='200')),
        ))
    ...
    models = {
        ...
        u'theme.homepage': {
            ...
            'arrangevisit_link': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
            'content': ('mezzanine.core.fields.RichTextField', [], {}),
            'introtext_heading': ('django.db.models.fields.CharField', [], {'default': "'start a love for learning'", 'max_length': '200'}),
            'ourfees_heading': ('django.db.models.fields.CharField', [], {'default': "'our fees'", 'max_length': "'200'"}),
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['pages.Page']", 'unique': 'True', 'primary_key': 'True'}),
            'seesetting_link': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
            'wedo_heading': ('django.db.models.fields.CharField', [], {'default': "'some of the things we get upto'", 'max_length': '200'}),
            ...
            'whatsaying_heading': ('django.db.models.fields.CharField', [], {'default': "'what parents are saying'", 'max_length': "'200'"})
        },
