...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DoBox.title'
        db.add_column(u'theme_dobox', 'title',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=255),
                      keep_default=False)

        # Adding field 'DoBox.text'
        db.add_column(u'theme_dobox', 'text',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DoBox.title'
        db.delete_column(u'theme_dobox', 'title')

        # Deleting field 'DoBox.text'
        db.delete_column(u'theme_dobox', 'text')
