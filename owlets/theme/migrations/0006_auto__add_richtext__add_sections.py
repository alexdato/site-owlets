...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'theme_sections', (
            (u'richtext_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['theme.RichText'], unique=True, primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='section', to=orm['theme.RichText'])),
            ('content', self.gf('mezzanine.core.fields.RichTextField')(blank=True)),
        ))
        db.send_create_signal(u'theme', ['Sections'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'theme_sections')
    ...
    models = {
        ...
        u'theme.sections': {
            'Meta': {'ordering': "(u'_order',)", 'object_name': 'Sections', '_ormbases': [u'theme.RichText']},
            ...
            u'richtext_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['theme.RichText']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'theme.slide': {
